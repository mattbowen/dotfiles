...
#export LP_PS1_FILE=~/.config/liquidprompt/nojhan.ps1
...
# recommended value is 0
# See export LP_TITLE_OPEN and export LP_TITLE_CLOSE to change escape characters to adapt this
